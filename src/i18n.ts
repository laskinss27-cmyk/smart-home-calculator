...
const ATTR_RU: Record<string, string> = {
  ...
  "Distance": "Расстояние",
  // Доп. ключи Shelly
  "Max switching voltage AC": "Макс. ком. напряжение AC",
  "Max switching voltage DC": "Макс. ком. напряжение DC",
  "Max switching current AC": "Макс. ком. ток AC",
  "Max switching current DC": "Макс. ком. ток DC",
  "Max. switching voltage AC": "Макс. ком. напряжение AC",
  "Max. switching voltage DC": "Макс. ком. напряжение DC",
  "Max. measurement power": "Макс. измеряемая мощность",
  "Battery life": "Срок службы батареи",
  "Local and remote control": "Локальное и удалённое управление",
  "Terminal Color": "Цвет клемм",
  "Connectors color": "Цвет коннекторов",
  "Power supply voltage AC": "Напряжение питания AC",
  "Power supply voltage DC": "Напряжение питания DC",
  "Power supply, USB": "Питание, USB",
  "USB TYPE-C power supply": "Питание USB Type-C",
  "Maximum radio frequency power transmitted in frequency band(s)":
    "Макс. РЧ-мощность в рабочих диапазонах",
  "Screw terminals max. torque": "Макс. момент затяжки клемм",
  "Z-Wave – repeater": "Z-Wave — ретранслятор",
  "Z-Wave - repeater": "Z-Wave — ретранслятор",
  "Z-Wave – frequency band": "Z-Wave — частотный диапазон",
  "Z-Wave - frequency band": "Z-Wave — частотный диапазон",
  "Zigbee repeater": "Zigbee-ретранслятор",
  "Voltage protection / Cutoff": "Защита/отсечка по напряжению",
  "Current protection / Cutoff": "Защита/отсечка по току",
  "Max power protection / Cutoff": "Защита/отсечка по мощности",
  "Sunrise/Sunset": "Рассвет/закат",
  "Weekly Schedule": "Недельное расписание",
  "G-sensor": "Датчик ускорения (G-sensor)",
  "Relay": "Реле",
  "Ammeter accuracy": "Точность амперметра",
  "Data export": "Экспорт данных",
  "Clock frequency": "Тактовая частота",
  "Device temperature protection": "Защита по температуре устройства",
  "No load threshold": "Порог отсутствия нагрузки",
  "Dimming": "Диммирование",
  "Power measurement [W]": "Измерение мощности (Вт)",
  "Intelligent On/Off": "Интеллектуальное вкл/выкл",
  "UL Listed option": "Сертификация UL",
  "Beacon mode": "Режим маяка (BLE)",
  "Wireless/WiFi Protocol": "Беспроводной протокол / Wi-Fi",
  ...
  "System": "ОС",
  "Size (HxD)": "Размеры (В×Д)",
  "Socket": "Цоколь",
  "Brightness": "Яркость",
  "Beam angle": "Угол светового потока",
